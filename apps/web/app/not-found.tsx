...
export default function NotFound() {
  return (
    <main className="mx-auto grid min-h-[70vh] w-[min(100%-3rem,45rem)] content-center gap-5">
      <span className="font-mono text-[11px] tracking-[0.1em] text-cyan-500">404 / 路由不存在</span>
      ...
      <Link className="w-max border border-cyan-400 px-4 py-3 text-cyan-400" href="/zh">
        返回首页 →
      </Link>
    </main>
  )
